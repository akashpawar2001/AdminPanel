                    ...
                    <div class="rounded-t mb-0 px-0 border-0">
                      ...
                      <div class="block w-full overflow-x-auto">
                        <table class="items-center w-full bg-transparent border-collapse">
                          ...
                          <tbody>
                        <% ArrayList<User> data=(ArrayList<User>) request.getAttribute("CUSTOMERS"); %>
                        <%for(User u:data){ %>
                            <tr class="text-gray-700 dark:text-gray-100">
                              <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left"><%=u.getFirstName() %> <%=u.getLastName() %></th>
                              <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"><%=u.getEmailAddress() %></td>
                              <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                <div class="flex items-center">
                                  <span class="mr-2"><%=u.getContact() %></span>
                                </div>
                              </td>
                            </tr>
                           <%} %>
